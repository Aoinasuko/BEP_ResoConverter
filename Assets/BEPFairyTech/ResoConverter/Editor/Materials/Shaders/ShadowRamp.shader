// Adapted from lilToon. Copyright (c) 2020-present lilxyzw. MIT license; see ../COPYING.md.
Shader "Hidden/BEPFairyTech/ResoConverter/ShadowRamp"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float lilTooningScale(float aascale, float value, float border, float blur)
            {
                ...
                return saturate((value - borderMin) / max(0.00001, saturate(borderMax - borderMin)));
            }
