...
1. 配布された `BEP_ResoConverter-v0.3.3.unitypackage` をインポートします。公開済みの版は [Releases](https://github.com/Aoinasuko/BEP_ResoConverter/releases) から取得できます。配置先は `Assets/BEPFairyTech/ResoConverter` です。
