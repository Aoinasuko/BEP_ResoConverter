...
[IO.File]::WriteAllText((Join-Path $stagingRoot 'bep-features.json'), '{"facialExpressions":3,"avatarEyeLook":1,"physBoneLimits":1,"desktopHandGestures":1}', [Text.UTF8Encoding]::new($false))
