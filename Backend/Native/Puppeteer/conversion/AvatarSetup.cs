...
public partial class RootConverter
{
    ...
    {
        if (!_options.asAvatar) return null;
    ...
    private async Task<f.Slot> CreateSettingsNode()
    {
        ...
        _coreSys = _options.asAvatar ? await _context.Gadgets.CoreSystems.Spawn(coreSys) : coreSys;
    ...
    {
        var tmpSlot = slot.FindChild("CenteredRoot") ?? slot;
