...
internal class Program
{
    ...
    )
    {
        ...
        try
        {
            ...
            var settings = ConverterSettings.Read(args.settingsPath);
            using var converter = new RootConverter(engineController, engineController.World, statusStream, settings);
            ...
            if (settings.verifyAfterExport)
                await NativeVerification.Verify(engineController.World, args.outputPath);
